...
- A verdict, label or sentence that says or implies an asset is safe, endorsed,
  risk-free or independently reviewed. None of those is something this kit can
  establish: it reports facts, and the absence of known blockers under a policy
  the caller declared.
